...
var GCERelay = /** @class */ (function (_super) {
    __extends(GCERelay, _super);
    function GCERelay() {
        var _a;
        var _this = _super.call(this) || this;
        _this.device = ((_a = config.door.options) === null || _a === void 0 ? void 0 : _a.device) || "/dev/ttyUSB0";
        return _this;
    }
    GCERelay.prototype.moveUp = function () {
    ...
    GCERelay.prototype.moveDown = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                exec("echo RLY" + config.door.options.upPin + (!config.door.options.activateWhen ? "1" : "0") + " > " + this.device);
                exec("echo RLY" + config.door.options.downPin + (config.door.options.activateWhen ? "1" : "0") + " > " + this.device);
    ...
    GCERelay.prototype.stop = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
